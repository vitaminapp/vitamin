      ...
      <div class="padding-24 margin-24-top bg-white overflow">
        ...
        <div class="ant-table-wrapper index-table margin-24-top margin-24-btm">
          <el-table :data="tempList" style="width: 100%;background: #595959;">
            <el-table-column prop="vm_store_name" label="店铺名称" width="202" />
            <el-table-column prop="floor_name" label="楼层" width="79" />
            <el-table-column prop="summary" label="店内促销" width="282" />
            <el-table-column prop="activity_time_str" label="活动时间" width="388" />
            <el-table-column prop="status_str" label="状态" width="99" />
...
export default {
  ...
  async created() {
    await this.getpromotion({ page: 1 })
  ...
  methods: {
    ...mapActions('marketing', ['getpromotion', 'getsearch']),
    ...
    updata() {
      this.filterParams = [
        ...
        { label: '楼层', key: 'floor_name', type: 'elSelect' },
        { label: '分类', key: 'name_id', type: 'elSelect', list: null },
        { label: '状态', key: 'vm_store', type: 'elSelect', list: null },
